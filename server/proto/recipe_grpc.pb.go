...
const (
	RecipeService_GetRecipe_FullMethodName    = "/recipes.RecipeService/GetRecipe"
	RecipeService_ListRecipes_FullMethodName  = "/recipes.RecipeService/ListRecipes"
	RecipeService_CreateRecipe_FullMethodName = "/recipes.RecipeService/CreateRecipe"
	RecipeService_UpdateRecipe_FullMethodName = "/recipes.RecipeService/UpdateRecipe"
	RecipeService_DeleteRecipe_FullMethodName = "/recipes.RecipeService/DeleteRecipe"
)
...
var RecipeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "recipes.RecipeService",
